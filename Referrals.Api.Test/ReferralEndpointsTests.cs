...
namespace Referrals.Api.Test
{
    /// <summary>
    /// Referral Endpoints Tests type.
    /// </summary>
    public sealed class ReferralEndpointsTests : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        /// </summary>
        public ReferralEndpointsTests(WebApplicationFactory<Program> factory)
        {
            _factory = factory;
        }
        ...
        [Fact]
        /// <summary>
        /// List My Referrals User Has Seeded Complete Referrals.
        /// </summary>
        public async Task ListMyReferrals_UserHasSeededCompleteReferrals()
        {
            var client = _factory.CreateClient();
            client.DefaultRequestHeaders.Add("X-Mock-UserId", "user_123");
